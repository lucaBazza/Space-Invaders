...
public class User : MonoBehaviour, IDataPersistence
{
    ...
    [SerializeField] public static bool isGodMode = false;    // Only for testing env
    ...
    */
    ...
    /*
        IDataPersistence load / save game
    */
    public void LoadData(GameData data)
    {
        alienKilledTotal = data.alienKilledTotal;
        bulletsFired = data.bulletsFired;
        deadsPlayer = data.deadsPlayer;
        // level is store on AlienPool
        highestScore = data.highestScore;
        // globalPrecision is saved for query stats but not loaded (is total aliens/bullets)
        timePlayedTotal = data.timePlayedTotal;
        totalNumberSessions = data.sessionTotal;
        userName = data.userName;
    }

    public void SaveData(GameData data)
    {
        data.alienKilledTotal = alienKilledTotal;
        ...
        data.gameDataTime = DateTime.Now.ToString("yyyy-MM-dd h:mm:ss"); // TODO: Use firebase/cloud time function instead
    }
}
